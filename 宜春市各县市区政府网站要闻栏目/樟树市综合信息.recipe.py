...
class yuanzhouyaowen(BasicNewsRecipe):
    ...
    title = '樟树市综合信息'
    description = '抓取樟树市政府网综合信息专栏'
#   cover_url = 'http://akamaicovers.oreilly.com/images/0636920024972/lrg.jpg'


    url_prefix = 'http://www.zhangshu.gov.cn/zwgk/zhxx/'
    no_stylesheets = True
    keep_only_tags = [{ 'style': 'border:#cde2f6 1px solid; margin-bottom:8px;' }]
...
#   oldest_article = 1  #下载的最旧的文章是几天前的。默认是7天，单位是天。如果文章有日期，这个参数起作用。但是这个日期暂时不知道怎么认定，这个参数在宜春政府网的政务要闻不起作用
    ...
    def parse_index(self):
        ...
        翻页后第2页的链接形式为“http://www.zhangshu.gov.cn/zwgk/zhxx/index_1.html”
